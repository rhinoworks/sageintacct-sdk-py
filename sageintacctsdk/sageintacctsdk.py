...
from .apis import ApiBase, Contacts, Contracts, ContractLines, Locations, Employees, Accounts, ExpenseTypes, Attachments, ExpenseReports,\
    ...
    RevRecSchedules, RevRecScheduleEntries, CostTypes, APBillItem, SODocument, ARPaymentItem, OrderEntryTransactions, Allocations, AllocationEntry
...
class SageIntacctSDK:
    ...
    def __init__(self, sender_id: str, sender_password: str, user_id: str,
        ...
        self.contract_lines = ContractLines()
    ...
    def update_sender_id(self):
        ...
        self.contract_lines.set_sender_id(self.__sender_id)
        ...
        self.ap_bill_item.set_sender_id(self.__sender_id)
    ...
    def update_sender_password(self):
        ...
        self.contract_lines.set_sender_password(self.__sender_password)
        ...
        self.ap_bill_item.set_sender_password(self.__sender_password)
    ...
    def update_session_id(self):
        ...
        self.contract_lines.set_session_id(self.__session_id)
        ...
        self.ap_bill_item.set_session_id(self.__session_id)
    ...
    def update_show_private(self):
        ...
        self.contract_lines.set_show_private(self.__show_private)
